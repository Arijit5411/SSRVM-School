...
export const getStaticProps = async () => {
    ...
    const res1 = await fetch(`${GlobalSiteUrl}/api/shraddha-trainings?populate=*`)
        ...
        <>
            ...
            <Fragment>
                ...
                {loading ? (
                    ...
                    <section className="wrap-training-item-se2">
                        <div className="top-section23">
                            <section className="container">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h1 className="wrap-training-item">
                                            {shardhaData.title && (
                                                <span
                                                    dangerouslySetInnerHTML={{ __html: shardhaData.title.replace(/\n/g, "<br />") }}
                                                ></span>
                                            )}
                                        </h1>
                                        <p className="fontSize22">
                                            {shardhaData.content && (
                                                <span
                                                    dangerouslySetInnerHTML={{ __html: shardhaData.content.replace(/\n/g, "<br />") }}
                                                ></span>
                                            )}
                                        </p>
                                    </div>
