                  ...
                  <div className="col-12 col-md-6 col-lg-6">
                    <div className="input-wrap color-1">
                      ...
                      >
                        ...
                        {data1?.data[0].attributes.Job_Role?.map(function (d) {
                          if (d.Job_Role !== null) {
                  ...
                  <div className="col-12 col-md-6 col-lg-6">
                    <div className="input-wrap color-1">
                      ...
                      >
                        ...
                        {data1?.data[0].attributes.Preferred_Locations?.map(function (d) {
                  ...
                  <div className="col-12 col-md-6 col-lg-6">
                    <div className="input-wrap color-1">
                      ...
                      >
                        ...
                        {data1?.data[0].attributes.Job_Categories?.map(function (d) {
                    ...
                    <div className="col-12 col-md-6 col-lg-6">
                      <div className="input-wrap color-1">
                        ...
                        >
                          ...
                          {data1?.data[0].attributes.Salary_Expectations?.map(
                            function (d) {
